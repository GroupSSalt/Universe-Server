function loadAppstore() {
  ...
  <div class="tabs">
		...
		<button class="padIcon" onClick="openTab('appstore-clicker')"><img class="padImage" src="https://github.com/GroupSSalt/Universe-Server/blob/main/appstore/clicker/clicker.png"></button>
	</div>
		<div class="tabcontent" id="appstore-clicker">
	<center>
			<h1>Universe Clicker</h1>
			<img src="https://github.com/GroupSSalt/Universe-Server/blob/main/appstore/clicker/clicker.png"><br>
